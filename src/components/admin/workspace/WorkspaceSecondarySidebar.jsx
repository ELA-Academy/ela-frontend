...
const WorkspaceSecondarySidebar = ({
  ...
  const allChannels = conversations.filter(
    (item) => (item.conversation_type === "channel" || item.conversation_type === "department" || item.conversation_type === "department_private" || item.conversation_type === "private_channel") && !closedDmIds.includes(item.id)
  ...
  const renderConversationLink = (conversation, icon, extraClass = "") => {
    ...
    const isChannel = conversation.conversation_type === "channel" || conversation.conversation_type === "department" || conversation.conversation_type === "department_private" || conversation.conversation_type === "private_channel";
    let dmTitle = conversation.title;
